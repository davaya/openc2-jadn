...
that separates information sharing requirements from implementation details. This makes it uniquely suited
for conceptual design where details are unknown or undecided, for exposition and publication where they
are distracting, as well as for implementation where unambiguous specification of details using a
formal syntax is essential.
...
data formats and ensures that different solutions deliver equivalent results.
